package com.sinothk.QRCode.demo.create;
...
public class QrCodeCreateDemoMainActivity extends AppCompatActivity {
    ImageView qrcode1;
    ImageView qrcode2;
    ImageView qrcode3;
    ImageView qrcode4;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_demo_create_1);
